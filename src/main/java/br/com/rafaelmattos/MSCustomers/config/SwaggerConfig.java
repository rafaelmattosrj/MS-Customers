...
public class SwaggerConfig {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2)
				...
				.basePackage("br.com.rafaelmattos.loja.resources"))
	...
	private ApiInfo apiInfo() {
		return new ApiInfo("API do Rafael Mattos", 
				"Aplicação responsável pelo gerenciamento de clientes do Rafael Mattos", 
				"Versão 1.0", 
				"",
				new Contact("Rafael Mattos", 
				"https://linktr.ee/rafael.mattos", 
				"rafaelrj@live.com"),
				"Permitido uso comum", 
				"", 
